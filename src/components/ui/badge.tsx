...
const badgeVariants = cva(
  "flex items-center rounded-full border border-stone-200 px-2.5 py-0.5 text-sm transition-colors focus:outline-none focus:ring-2 focus:ring-stone-950 focus:ring-offset-2 dark:border-stone-800 dark:focus:ring-stone-300",
  {
    variants: {
      variant: {
        default:
